...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmDoctores = $conexion->prepare("INSERT INTO doctores (nombre, apellido,fechas) VALUES (?, ?, ?)");
    $stmDoctores->bind_param("sss", $nombre, $apellido, $fecha);
    $stmDoctores->execute();
    $stmDoctores->close();
...
<body>
    ...
    <h1 class="text-center">Añadir Doctor</h1>
