...
$consulta = "SELECT p.*, r.* FROM personas p JOIN registros r ON p.id = r.persona_id WHERE p.id = $idPaciente";
    ...
    <div class="card">
        <div class="card-body">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><strong class="text-primary">Antecedentes:</strong> <?php echo $paciente['pregunta']; ?></li>
